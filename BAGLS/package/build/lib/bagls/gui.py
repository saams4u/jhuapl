...
# Image utils
from bagls.biomedical_image_utils import generate_dataset, generate_training_data, nd2_converter, tiff_converter, roi_to_mask
    ...
    def dropEvent(self, event):
        ...
        for elem in event.mimeData().urls():
            ...
            if tab1_imageExtension == "nd2" or tab1_imageExtension == "tiff" or tab1_imageExtension == "tif" or tab1_imageExtension == "png" or tab1_imageExtension == "jpg":
                ...
                output_name.setText(f"Predicted Segmentation (Blue): {os.path.basename(file_path.replace('.'+tab1_imageExtension,'_blend.png'))}")
...
def show_gui():
    ...
    # ------------------------------------TAB 1---------------------------------------
    tab1 = QWidget()
    tabs.addTab(tab1, "Predict Segmentation")
